...
from neurec.util import learner, DataGenerator, tool, reader
...
class DiffNet(SocialAbstractRecommender):
    ...
    def __init__(self, **kwds):
        ...
        self.user_feature_file = self.conf["user_feature_file"]
        self.item_feature_file = self.conf["item_feature_file"]
        self.feature_dimension = self.conf["feature_dimension"]
    ...
    def _create_variables(self):
        ...
        lines = reader.lines(self.user_feature_file)
        ...
        lines = reader.lines(self.item_feature_file)
